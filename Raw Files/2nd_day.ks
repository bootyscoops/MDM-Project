...
[font color=0xbcbcbc]翼[resetfont]「おお、彼がどうした?[br]
...
[font color=0xe1c65e]文吾[resetfont]「タチの悪い冗談は止めてくれやあ、管理人さんよぉ…。[br]
...
[select]
[links target=*電話1]電話に出る[endlink][r]
[links target=*電話2]電話に出ない[endlink][r]
[endselect]
[wait time=5000]
[jump target=*電話3]
[s]
...
[er]
いつも通りの一人きりの夕食を終えると、[br]
俺は使い終わった食器をシンクで洗い、[br]
テーブルを布巾で拭いた。[br]
[er]
[font color=0x9eba8a][emb exp=sf.name][resetfont]「さて、と」[br]
[er]
俺は本棚から管理日誌を取ると、テーブルに広げてペンを走らせた。[br]
今日の日付を記し、今日起きた出来事を書き綴る。[br]
[er]
このアパートの管理人になってから、[br]
毎日付けるようにしている管理日誌。[br]
...
同じく104号室、津久井秀太郎(つくい　しゅうたろう)君。[br]
...
[select]
[links target=*ノート1]1.6人もいれば1人くらいは…[endlink][r]
...
[select]
[links target=*運命の人]1.もしかしたら道明寺さんと…[endlink][r]
...
[links target=*運命の人]5.ノンケとわかっていても林さんと…[endlink][r]
